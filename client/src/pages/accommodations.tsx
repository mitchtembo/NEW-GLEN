    ...
    <div className="min-h-screen bg-warm-gray">
      ...
      <section className="py-16 bg-gradient-to-r from-forest to-sage text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-4xl md:text-5xl font-bold mb-4">Accommodations</h1>
          <p className="text-xl opacity-90 max-w-3xl mx-auto">
            Choose from our range of comfortable accommodations. 
            From luxury mountain chalets to budget-friendly dorms and authentic camping experiences.
          </p>
        </div>
      </section>
